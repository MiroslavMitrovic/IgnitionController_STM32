...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" rev-parse "${ref}^0"
...
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" show-ref "release-1.12.1"
  WORKING_DIRECTORY "D:/projects/atmel/attiny85/IgnitionController/unitTests/build/_deps/googletest-src"
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" fetch --tags --force "origin"
    WORKING_DIRECTORY "D:/projects/atmel/attiny85/IgnitionController/unitTests/build/_deps/googletest-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" symbolic-ref -q HEAD
    WORKING_DIRECTORY "D:/projects/atmel/attiny85/IgnitionController/unitTests/build/_deps/googletest-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "D:/projects/atmel/attiny85/IgnitionController/unitTests/build/_deps/googletest-src"
...
if(need_stash)
  execute_process(
    COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "D:/projects/atmel/attiny85/IgnitionController/unitTests/build/_deps/googletest-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" checkout "${checkout_name}"
    WORKING_DIRECTORY "D:/projects/atmel/attiny85/IgnitionController/unitTests/build/_deps/googletest-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" rebase "${checkout_name}"
    WORKING_DIRECTORY "D:/projects/atmel/attiny85/IgnitionController/unitTests/build/_deps/googletest-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/projects/atmel/attiny85/IgnitionController/unitTests/build/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/projects/atmel/attiny85/IgnitionController/unitTests/build/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
